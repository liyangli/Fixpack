...
<title>JSP上传文件</title>   
<script type="text/javascript" language="javascript" src="/resources/plugin/ckeditor/ckeditor.js"></script>
</head>   
<body>   
<%   
if(ServletFileUpload.isMultipartContent(request)){   
    ...
    for (FileItem item : fileItemsList) {   
        if (!item.isFormField()) {   
            ...
            String clientPath = "resources/uploader/upload/" + type + fileName;   
